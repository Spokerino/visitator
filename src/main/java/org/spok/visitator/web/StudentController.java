...
//@RequestMapping(value="/faculties/{facultyId}/groups/{groupId}/students/{studentId}", 
//method=RequestMethod.GET)
//public ModelAndView StudentFromGroupGet(@PathVariable Integer collegeId,
//@PathVariable Long facultyId,
//@PathVariable Long groupId,
//@PathVariable Long studentId) {
//
...
//method=RequestMethod.GET)
//public ModelAndView editStudentFromCollegeGet(@PathVariable Integer collegeId,
//									  @PathVariable Long studentId) {
//
//CollegeStudent student = (CollegeStudent) studentRepository.findStudentById(studentId);
//ModelAndView model = addStudentFromCollegeGet(collegeId); 
//model.setViewName("college/editCollegeStudent");
//model.addObject("student", student);
//
//return model;
//}
...
//@RequestMapping(value="/students/{studentId}/edit",
//method=RequestMethod.POST)
//public ModelAndView editStudentFromCollegePost(@PathVariable Integer collegeId,
//								   @PathVariable Long studentId,
//							 	   @Valid @ModelAttribute("student") CollegeStudent student,
//							 	   BindingResult result,
//							 	   @RequestParam(required=false, value="check") String isDeleted,
...
//if(isDeleted == null)
//{
//CollegeStudent st = (CollegeStudent) studentRepository.findStudentById(studentId);
//CollegeGroup group = (CollegeGroup) st.getGroup(); 
//
//if(result.hasErrors()) {
//	ModelAndView model = new ModelAndView();
//	List<EducationSpecialization> faculties = specializationRepository.findAllFaculties(collegeId);
...
//studentRepository.updateStudent(student);
//
//return new ModelAndView("redirect:/colleges/{collegeId}/students");
//}
//else
//{
//studentRepository.deleteStudent(studentId);
...
//}
//
//@RequestMapping(value="/faculties/{facultyId}/students/{studentId}/edit", 
//method=RequestMethod.GET)
//public ModelAndView editStudentFromFacultyGet(@PathVariable Integer collegeId,
//									  @PathVariable Long facultyId,
//									  @PathVariable Long studentId) {
//
//CollegeStudent student = (CollegeStudent) studentRepository.findStudentById(studentId);
//ModelAndView model = addStudentFromCollegeGet(collegeId); 
//model.setViewName("faculty/editFacultyStudent");
//model.addObject("student", student);
//
//return model;
//}
...
//@RequestMapping(value="/faculties/{facultyId}/students/{studentId}/edit",
//method=RequestMethod.POST)
//public ModelAndView editStudentFromFacultyPost(@PathVariable Integer collegeId,
//								   @PathVariable Long studentId,
//								   @PathVariable Long facultyId,
//							 	   @Valid @ModelAttribute("student") CollegeStudent student,
//							 	   BindingResult result,
...
//studentRepository.updateStudent(student);
//
//return new ModelAndView("redirect:/colleges/{collegeId}/faculties/{facultyId}/students");
//}
//else
//{
//studentRepository.deleteStudent(studentId);
